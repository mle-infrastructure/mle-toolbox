...
git_tar = f"https://github.com/RobertTLange/mle-toolbox/archive/v{verstr}.tar.gz"


setup(name='mle_toolbox',
      version=verstr,
      ...
      install_requires=parse_requirements(os.path.join(CURRENT_DIR,
                                                       'requirements',
                                                       'requirements.txt')),
      tests_require=parse_requirements(os.path.join(CURRENT_DIR,
                                                    'requirements',
