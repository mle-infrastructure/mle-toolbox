...
def mnist_postprocessing(experiment_dir, figures_dir):
    ...
    fig, ax = plt.subplots()
    ax.plot(loaded_log.meta_log.time.num_updates, loaded_log.meta_log.stats.test_loss)
    ax.set_xlabel("Number of Batch Updates")
    ax.set_ylabel("Test Loss")
    ax.set_title("MNIST MLP Test Loss")
    fig.savefig(os.path.join(figures_dir, "mnist_learning_curve.png"), dpi=300)
...
if __name__ == "__main__":
    ...
    mnist_postprocessing(cmd_args.experiment_dir, cmd_args.figures_dir)
