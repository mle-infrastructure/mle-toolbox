...
def retrieve_build_subparser(subparsers):
    ...
    parser_retrieve = subparsers.add_parser("retrieve", help="Retrieve a "
                                            "completed experiment from"
                                            " a cluster/GCS bucket.")
...
def report_build_subparser(subparsers):
    ...
    parser_report = subparsers.add_parser("report", help="Generate set of "
                                          "reports (.html/.md) from "
                                          "experiment results.")
...
def monitor_build_subparser(subparsers):
    ...
    parser_monitor = subparsers.add_parser("monitor", help="Monitor a compute "
                                           "resource and view experiment"
                                           " protocol.")
...
def sync_gcs_build_subparser(subparsers):
    """ Build subparser arguments for `init` subcommand. """
    parser_sync = subparsers.add_parser("sync-gcs", help="Sync all new results"
...
def init_build_subparser(subparsers):
    """ Build subparser arguments for `init` subcommand. """
    parser_init = subparsers.add_parser("init", help="Setup the toolbox .toml "
                                        "config with credentials/defaults.",)
