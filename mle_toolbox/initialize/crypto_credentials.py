...
def encrypt(key: Union[str, bytes], source: Union[str, bytes], encode: bool = True):
...
def decrypt(key: Union[str, bytes], source: Union[str, bytes], decode: bool = True):
...
def encrypt_ssh_credentials(user_name: Union[str, bytes], password: Union[str, bytes]):
...
if __name__ == "__main__":
    user_name = "user"
    password = "pass!"
    aes_key, enc_user_name, enc_password = encrypt_ssh_credentials(user_name, password)
    print(aes_key, enc_user_name, enc_password)
    dec_user_name, dec_password = decrypt_ssh_credentials(
        aes_key, enc_user_name, enc_password
    )
